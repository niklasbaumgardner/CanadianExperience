...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_TREEOPTIONS_STARTTREE1, &CMainFrame::OnTreeoptionsStarttree1)
	ON_COMMAND(ID_TREEOPTIONS_STARTTREE2, &CMainFrame::OnTreeoptionsStarttree2)
	ON_COMMAND(ID_TREEOPTIONS_HARVEST, &CMainFrame::OnTreeoptionsHarvest)
END_MESSAGE_MAP()
...
void CMainFrame::OnTreeoptionsStarttree1()
{
	// TODO: Add your command handler code here
	auto tree = mPictureFactory.GetTree1();
	tree->SetKeyFrame(mPicture->GetTimeline()->GetCurrentFrame());
	mPicture->UpdateObservers();
}


void CMainFrame::OnTreeoptionsStarttree2()
{
	// TODO: Add your command handler code here
	auto tree = mPictureFactory.GetTree2();
	tree->SetKeyFrame(mPicture->GetTimeline()->GetCurrentFrame());
	mPicture->UpdateObservers();
}


void CMainFrame::OnTreeoptionsHarvest()
{
	// TODO: Add your command handler code here
	auto tree1 = mPictureFactory.GetTree1();
	auto tree2 = mPictureFactory.GetTree2();
	tree1->Harvest();
	tree2->Harvest();
	mPicture->UpdateObservers();
}
